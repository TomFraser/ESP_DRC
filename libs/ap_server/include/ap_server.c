...
static esp_err_t settings_handler(httpd_req_t *req)
{
    ...
    const char* resp_str = "<!DOCTYPE html><html><head></head><body><h1>Settings</h1><form action='/settings'>Speed:<br><input type='text' name='speed' value='100'><br><br>Steering Offset:<input type='text' name='steering' value='100'><input type='submit' value='Submit'></form><form action='/'><input type='submit' value=''></form></body></html>";
...
static esp_err_t terminal_handler(httpd_req_t *req)
{
    ...
    sprintf(resp_str, "<!DOCTYPE html><html><head><meta http-equiv='refresh' content='2'></head><body style='font-size=50px;'>%s<br><form action='/'><input type='submit' value=''></form></body></html>", terminal[0]);
    httpd_resp_send(req, resp_str, strlen(resp_str));
